...
- Using the opioid independent variables, selected 10 of the strongest predictors to fit a logistic regression model
...
- Included an additional 20 predictors (30 total) to implement sampling and lasso regressionto
