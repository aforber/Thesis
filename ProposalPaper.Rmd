...
$\qquad$ The predictors were first narrowed from ? to 35 (?) based on clinical relevance. 
...
Among these set of variables, which ones are most important in classifying. 
supervised learning problem (because observed outcome)
