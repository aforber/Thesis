...
$\qquad$ This issue now presents a statical problem, as this is a rare outcome which makes prediction more challenging. Predictive modeling with imbalanced data has been found to report low sensitivity (reference?). Many people have tried to combat this issue in the past. 
...
$\qquad$ The analysis was done in RStudio version 1.1.383. We used a roughly 2/3rd temporal split of the data to create training and testing datasets, where years 2008-2011 were used to train (65%), and 2012-2014 were used to test (35%). The predictors were narrowed from 50 to 35 based on clinical relevance. 
